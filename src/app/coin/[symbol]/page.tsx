...
export default function CoinPage({ params, searchParams }: CoinPageProps) {
  const resolvedParams = use(params);
  const resolvedSearchParams = use(searchParams);

  const coinData: CoinData | null = resolvedSearchParams?.data
    ? JSON.parse(atob(resolvedSearchParams.data))
    : null;
  ...
  }, [resolvedParams.symbol, selectedTimeframe]);
  ...
  return (
    <div className="min-h-screen p-6 space-y-6 pt-28">
      ...
      {error ? (
        ...
        <div className="space-y-6">
          {/* Header Section */}
          <div className="rounded-xl bg-gradient-to-r from-blue-900/20 via-purple-900/20 to-pink-900/20 border border-blue-500/20 backdrop-blur-sm p-6">
              ...
              {coinData?.image ? (
                ...
                <div className="w-20 h-20 rounded-full bg-gradient-to-br from-blue-500/20 to-purple-500/20 flex items-center justify-center">
                  <span className="text-3xl text-blue-300">
                    {resolvedParams.symbol.charAt(0).toUpperCase()}
                  </span>
                </div>
              )}
              <div className="flex-1">
                <div className="flex items-center gap-3">
                  <h1 className="text-3xl font-bold text-gray-200">
                    {coinData?.name || resolvedParams.symbol.toUpperCase()}
                  </h1>
            ...
            <div className="rounded-xl bg-gray-900/40 border border-gray-800 p-6 backdrop-blur-sm h-full">
              <div className="flex flex-col h-full">
                ...
                <div className="flex-1 min-h-[400px] relative">
                  ...
                  {!isChartLoading && getChartData().length === 0 && (
                    <div className="absolute inset-0 flex items-center justify-center bg-gray-900/20 backdrop-blur-sm rounded-lg">
                      <div className="flex flex-col items-center gap-4">
                        <p className="text-sm text-gray-400">
                          No data available
